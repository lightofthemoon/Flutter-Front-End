            ...
            onChanged: (value) {
              setState(() {
                ...
                if (widget.cardProduct.isSelected == true) {
                  widget.cardProduct.products.add(widget.cardProduct.products[0]);
                } else {
                  widget.cardProduct.products.remove(widget.cardProduct.products[0]);
                }
              });
            }),
        Expanded(
        ...
        Expanded(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  widget.cardProduct.products[0].name,
                  maxLines: 2,
                ...
                Text(
                  NumberFormat.simpleCurrency(locale: 'vi-VN', decimalDigits: 0)
                      .format(widget.cardProduct.products[0].price),
                  maxLines: 1,
                  overflow: TextOverflow.ellipsis,
                  ...
                  children: [
                    Container(
                        ...
                        child: InkWell(
                          ...
                          onTap: () {
                            // if (widget.cardProduct.products[0].price != 0) {
                    ...
                    Padding(
                      ...
                      child: Text(
                        widget.cardProduct.products.toString(),
                        style: const TextStyle(
                          fontSize: 17,
